...
namespace BastionFall.Features.Chat.Client.UI
{
    ...
    {
        [Header("Refs")] [SerializeField] private Transform contentRoot;

        [SerializeField] private ChatMessageItem templateItem;
        [SerializeField] private MessageStyleProvider styleProvider;

        [Header("Limits")] [SerializeField] private int maxOnScreen = 50;
        ...
        public void SetTyping(bool isTyping)
        {
            ...
            {
                var cm = child.GetComponent<ChatMessageItem>();
                if (cm != null) cm.ApplyAlpha(255);
        ...
        {
            var count = contentRoot.childCount;
